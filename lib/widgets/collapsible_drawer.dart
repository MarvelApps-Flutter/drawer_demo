...
class CollapsingNavigationDrawer extends StatefulWidget {
  ...
  const CollapsingNavigationDrawer({Key? key, this.isSimple, this.isHidden, this.isCollapse, this.isMultilevel, this.collapseSelectedIndex}) : super(key: key);
  @override
                        ...
                        return CollapsingListTile(
                          onTap: () {
                            setState(() {
                              ...
                              print("currentSelectedIndex is $currentSelectedIndex");
                              //print("widget.isSimple is ${isSimple}");
                            });
                            if(currentSelectedIndex == 0)
                              {
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> HomeScreen(
                                  isSimple: widget.isSimple, isHidden: widget.isHidden, isCollapse : widget.isCollapse, isMultilevel: widget.isMultilevel,
                                  collapsibleSelectedIndex: currentSelectedIndex,
                                )));
                              }
                            ...
                            {
                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> CardDetailsScreen(
                                isSimple: widget.isSimple, isHidden: widget.isHidden, isCollapse : widget.isCollapse, isMultilevel: widget.isMultilevel,
                                collapsibleSelectedIndex: currentSelectedIndex,
                              )));
                            }
